...
"[project]/src/components/HoloCard.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function HoloCard({ img, name, number, rarity = "rare holo", className, ...props }) {
    ...
    const springRotateX = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$spring$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpring"])(0, {
        stiffness: 150,
        damping: 30
    });
    const springRotateY = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$spring$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpring"])(0, {
        stiffness: 150,
        damping: 30
    });
    const springGlareX = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$spring$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpring"])(50, {
        stiffness: 150,
        damping: 30
    });
    const springGlareY = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$spring$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpring"])(50, {
        stiffness: 150,
        damping: 30
    });
    const springBackgroundX = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$spring$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpring"])(50, {
        stiffness: 150,
        damping: 30
    });
    const springBackgroundY = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$spring$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpring"])(50, {
        stiffness: 150,
        damping: 30
    });
    // CSS Custom Properties State
    const [dynamicStyles, setDynamicStyles] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HoloCard.useEffect": ()=>{
            // Sync springs to CSS variables
            const unsubscribeRotateX = springRotateX.on("change", {
                "HoloCard.useEffect.unsubscribeRotateX": (v)=>{
                    setDynamicStyles({
                        "HoloCard.useEffect.unsubscribeRotateX": (prev)=>({
                                ...prev,
                                '--rotate-x': `${v}deg`
                            })
                    }["HoloCard.useEffect.unsubscribeRotateX"]);
                }
            }["HoloCard.useEffect.unsubscribeRotateX"]);
            const unsubscribeRotateY = springRotateY.on("change", {
                "HoloCard.useEffect.unsubscribeRotateY": (v)=>{
                    setDynamicStyles({
                        "HoloCard.useEffect.unsubscribeRotateY": (prev)=>({
                                ...prev,
                                '--rotate-y': `${v}deg`
                            })
                    }["HoloCard.useEffect.unsubscribeRotateY"]);
                }
            }["HoloCard.useEffect.unsubscribeRotateY"]);
            const unsubscribeGlareX = springGlareX.on("change", {
                "HoloCard.useEffect.unsubscribeGlareX": (v)=>{
                    setDynamicStyles({
                        "HoloCard.useEffect.unsubscribeGlareX": (prev)=>({
                                ...prev,
                                '--pointer-x': `${v}%`
                            })
                    }["HoloCard.useEffect.unsubscribeGlareX"]);
                }
            }["HoloCard.useEffect.unsubscribeGlareX"]);
            const unsubscribeGlareY = springGlareY.on("change", {
                "HoloCard.useEffect.unsubscribeGlareY": (v)=>{
                    setDynamicStyles({
                        "HoloCard.useEffect.unsubscribeGlareY": (prev)=>({
                                ...prev,
                                '--pointer-y': `${v}%`
                            })
                    }["HoloCard.useEffect.unsubscribeGlareY"]);
                }
            }["HoloCard.useEffect.unsubscribeGlareY"]);
            const unsubscribeBgX = springBackgroundX.on("change", {
                "HoloCard.useEffect.unsubscribeBgX": (v)=>{
                    setDynamicStyles({
                        "HoloCard.useEffect.unsubscribeBgX": (prev)=>({
                                ...prev,
                                '--background-x': `${v}%`
                            })
                    }["HoloCard.useEffect.unsubscribeBgX"]);
                }
            }["HoloCard.useEffect.unsubscribeBgX"]);
            const unsubscribeBgY = springBackgroundY.on("change", {
                "HoloCard.useEffect.unsubscribeBgY": (v)=>{
                    setDynamicStyles({
                        "HoloCard.useEffect.unsubscribeBgY": (prev)=>({
                                ...prev,
                                '--background-y': `${v}%`
                            })
                    }["HoloCard.useEffect.unsubscribeBgY"]);
                }
            }["HoloCard.useEffect.unsubscribeBgY"]);
            return ({
                "HoloCard.useEffect": ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("holo-card relative w-full h-full", className),
        ref: cardRef,
...
_s(HoloCard, "iFPktZ2ptjnID/e1m8w/NkeMWTE=", false, function() {
    return [
...
_c = HoloCard;
var _c;
__turbopack_context__.k.register(_c, "HoloCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$HoloCard$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/HoloCard.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature(), _s1 = __turbopack_context__.k.signature();
'use client';
;
...
function CardSlot({ card, onClick, onDelete }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: card ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$HoloCard$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    img: card.image,
                    name: card.name,
...
//# sourceMappingURL=src_ae929a83._.js.map