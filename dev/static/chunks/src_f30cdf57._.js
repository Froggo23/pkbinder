    ...
    const handleAuth = async (e)=>{
        ...
        try {
            if (isLogin) {
                ...
                const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
                    email,
                    password,
                    options: {
                        data: {
...
_s(AuthPage, "8u91oAqOwIw9SQrq8eSPZIv7O7Q=", false, function() {
    return [
...
//# sourceMappingURL=src_f30cdf57._.js.map