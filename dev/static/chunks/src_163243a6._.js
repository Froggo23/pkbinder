...
function Home() {
    ...
    const [binderId, setBinderId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    async function handleSave() {
        ...
        try {
            ...
            let result;
            if (binderId) {
                result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('binders').update(payload).eq('id', binderId);
            } else {
                result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('binders').insert([
                    payload
                ]).select();
        ...
        "Home.useEffect": ()=>{
            ...
            const checkUser = {
                "Home.useEffect.checkUser": async ()=>{
                    ...
                    setUser(currentUser);
                    if (currentUser) {
                        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('binders').select('*').eq('user_id', currentUser.id).order('updated_at', {
                            ascending: false
                        }).limit(1).single();
                        if (data && !error) {
                            ...
                            if (!savedData) {
                                ...
                                setTimeout({
                                    "Home.useEffect.checkUser": ()=>setHasUnsavedChanges(false)
                                }["Home.useEffect.checkUser"], 200);
                            }
                        }
                    }
                }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            ...
            const timer = setTimeout({
                "Home.useEffect.timer": ()=>setShowPageCounter(false)
...
_s(Home, "0Y+bDF/di3bE4HPQacA+iiYVRzw=");
_c = Home;
...
//# sourceMappingURL=src_163243a6._.js.map